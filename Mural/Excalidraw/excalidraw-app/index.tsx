...
import WelcomeScreenLogoLight from "./flipboard/icons/logo-flipboard-light.png";
import WelcomeScreenLogoDark from "./flipboard/icons/logo-flipboard-dark.png";
import { RubricaIcon } from "./flipboard/icons/RubricaIcon";
import "./main.css";
...
const detectedLangCode = languageDetector.detect() || "es-ES";//defaultLang.code;
...
const ExcalidrawWrapper = () => {
  ...
  if (!isLoadingSession && !session?.user?.superUser && !session?.user?.cursosAlumno.includes(idCurso || "") && !session?.user?.cursosDocente.includes(idCurso || "")) {
    return (
      <section className="flex flex-col justify-center items-center h-full w-full">
        <h1>No tienes acceso a este mural</h1>
        <a href={`${FLIPBOARD_FRONTEND}/cursos`} className="text-blue-600 hover:underline">Volver a FlipBoard</a>
    ...
    >
      <Excalidraw
        ...
        UIOptions={{
          canvasActions: {
            toggleTheme: false,
            // clearCanvas: true, // en modo colaborativo no se deja limpiar el canvas
            export: {
              // onExportToBackend,
        ...
        //         console.log("Presionaste el boton de colaborar")
        //       }
        //     />
        //   );
        // }}
        renderTopRightUI={() =>
          ...
          <div className="flex gap-1">
            ...
            <LiveCollaborationTrigger isCollaborating={isCollaborating} onSelect={async () => {
              console.log("Presionaste el boton de colaborar")
            }} />
      ...
      >
        ...
        <Button
          ...
          className="absolute top-[4rem] left-2 z-[3]"
          startContent={<BackIcon theme={theme} />}
          title="Volver a murales"
        >
          Volver
        </Button>
        ...
        <WelcomeScreen>
          <WelcomeScreen.Center>
            {theme === THEME.LIGHT ?
              <img src={WelcomeScreenLogoLight} alt="" className="w-80 h-auto" />
              :
              <img src={WelcomeScreenLogoDark} alt="" className="w-80 h-auto" />
            }
